...
public final class ChatConfigManager {
    ...
    public Map<String, AutoReplyEntry> getAutoReplies() {
        ...
        replies.put("guide", new AutoReplyEntry(List.of("panduan", "cara main", "bingung", "command apa", "fitur server", "guide", "vguide", "mulai dari mana"), List.of("&fButuh panduan? Ketik &b/vguide &7untuk menu utama server.", "&7Cek juga &b/vrules&7, &b/vrank&7, &b/vproduct&7, dan &b/quests&7.")));
        ...
        replies.put("quest", new AutoReplyEntry(List.of("quest", "misi", "level quest", "cara quest", "quest jalan sendiri", "pilih quest", "mana quest"), List.of("&fQuest harus dipilih dulu lewat &b/quests&f atau &b/quests start <category>&f.", "&7Quest memakai Mana dan tidak jalan sendiri kalau belum dipilih.")));
