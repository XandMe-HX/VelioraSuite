...
public final class ChatConfigManager {
    ...
    public Map<String, AutoReplyEntry> getAutoReplies() {
        ...
        replies.put("gacha", new AutoReplyEntry(List.of("gacha", "key", "kunci", "crate", "buka crate", "kunci gacha"), List.of("&fBeli physical crate key lewat &b/keyshop&f. Key langsung masuk inventory.", "&7Pegang key lalu klik crate yang sesuai warnanya.")));
