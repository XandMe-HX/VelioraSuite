...
public final class TraderTradeItem {
    ...
    public TraderTradeItem(String id, Material material, String name, int amount, List<String> lore, List<String> enchantments, int stock, int customDamage, int fishingLuckBonus, boolean unrepairable, TraderPaymentType paymentType, long money, List<TraderFishRequirement> fishRequirements) {
        this.id = id;
